...
class IMAGE_MT_image(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("native_image.open", text="Open Image")
        ...
        if ima:
            ...
            if ima.filepath:
                layout.operator("native_image.save", text="Save Image")
            layout.operator("native_image.save_as", text="Save As Image")
            layout.operator("native_image.save_as", text="Save a Copy").copy = True
...
class IMAGE_HT_header(Header):
    ...
    def draw(self, context):
        ...
        layout.template_ID(sima, "image", new="image.new", open="native_image.open")
        if not show_render:
