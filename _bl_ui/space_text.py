...
class TEXT_HT_header(Header):
    ...
    def draw(self, context):
        ...
        row = layout.row(align=True)
        row.template_ID(st, "text", new="text.new", unlink="text.unlink", open="native_text.open")
...
class TEXT_MT_text(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("native_text.open", text="Open Text Block")

        if text:
            layout.operator("text.reload")

            layout.column()
            layout.operator("native_text.save", text="Save Text")
            layout.operator("native_text.save_as", text="Save Text As")
